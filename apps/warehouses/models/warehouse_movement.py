...
class WarehouseMovement(models.Model):
    ...
    source_warehouse = models.ForeignKey(Warehouse,on_delete=models.SET_NULL,null=True,blank=True,related_name='outgoing_movements', help_text='Warehouse stock LEFT from. NULL for supplier.')
